...
The AC cord on my laptop's power brick — the detachable figure-8 one that runs to the wall — has a break in it near the plug end, so it charges for a few seconds and then quits. I need a ten-foot replacement in my hands today, delivered or ready to collect, from Kestrel somewhere near me in Phenix City. I have saved the brick's data sheet, Kestrel's cord listings, the same-day offers the stores round here are showing, the store directory, their same-day terms and their standard delivery page. It is 2:40 pm on a Friday here right now, Central time. Work through every offer and give me the sheet: each one marked eligible or not, the reason code for the ones that are out, and what the eligible ones land at once tax and any fee are on. Then tell me how many offers are eligible, which offer I should take, and what that chosen offer totals. File layout is in `input/submission_format.md`.
