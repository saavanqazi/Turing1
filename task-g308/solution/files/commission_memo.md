...
| L-126 | DEAL-121 | PartnerD | DUPLICATE_LINE | DEAL-121 is claimed on more than one line (R3) |
...
- **L-005 DEAL-005 (PartnerC)** — a house line at 0% is not commissionable, so the absence of a June ledger posting is not a finding.
...
- **L-011 DEAL-010 (PartnerA)** — the ledger's net June postings for DEAL-010 total 27,400.00 against revenue 27,500.00, inside the 1% match tolerance.
- **L-012 DEAL-011 (PartnerB)** — a house line at 0% is not commissionable, so the absence of a June ledger posting is not a finding.
- **L-022 DEAL-020 (PartnerC)** — the extract repeats posting P-1019 for DEAL-020; it is one posting, so net June revenue is 47,000.00, which matches.
- **L-026 DEAL-024 (PartnerC)** — the partner attributes the deal to CUST-12 but NetSuite bills it to CUST-14; both are new customers so the reported 8% stands.
- **L-029 DEAL-026 (PartnerA)** — the ledger carries a reversal for DEAL-026 (P-1031) but the net June revenue is still 41,000.00, which matches.
- **L-033 DEAL-030 (PartnerA)** — DEAL-030 is claimed by PartnerA and PartnerB, but the co-sell register carries an active 60/40 split naming exactly those partners, so the two lines are not duplicates and each matches its share of the 12,500.00 net.
- **L-034 DEAL-030 (PartnerB)** — DEAL-030 is claimed by PartnerA and PartnerB, but the co-sell register carries an active 60/40 split naming exactly those partners, so the two lines are not duplicates and each matches its share of the 12,500.00 net.
- **L-035 DEAL-031 (PartnerC)** — the ledger's net June postings for DEAL-031 total 19,800.00 against revenue 20,000.00, inside the 1% match tolerance.
- **L-075 DEAL-071 (PartnerA)** — the ledger's net June postings for DEAL-071 total 101,885.00 against revenue 102,500.00, inside the 1% match tolerance.
- **L-094 DEAL-090 (PartnerD)** — the extract repeats posting P-1092 for DEAL-090; it is one posting, so net June revenue is 79,500.00, which matches.
...
- **L-137 DEAL-131 (PartnerA)** — DEAL-131 is claimed by PartnerA and PartnerD, but the co-sell register carries an active 50/50 split naming exactly those partners, so the two lines are not duplicates and each matches its share of the 11,500.00 net.
- **L-138 DEAL-131 (PartnerD)** — DEAL-131 is claimed by PartnerA and PartnerD, but the co-sell register carries an active 50/50 split naming exactly those partners, so the two lines are not duplicates and each matches its share of the 11,500.00 net.
